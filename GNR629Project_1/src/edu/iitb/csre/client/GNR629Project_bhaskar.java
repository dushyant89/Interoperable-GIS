...
public class GNR629Project_bhaskar {
    ...
    public void onModuleLoad() {
        ...
        server.put("Geoserver","http://localhost:8080/geoserver/");
        ...
        RequestBuilder builderForWMS=new RequestBuilder(RequestBuilder.GET, "http://localhost:8080/geoserver/wms?request=getCapabilities");
        
        //Getting the getCapabilities content for WCS for a default server
        RequestBuilder builderForWCS=new RequestBuilder(RequestBuilder.GET, "http://localhost:8080/geoserver/wcs?request=GetCapabilities");
    ...
    private static VerticalPanel prepareWCSPanel(RequestBuilder builder,final String serverUrl)
    {
        ...
        final HTML detailsLabel=new HTML("<p style='border-bottom:1px solid black;'>Details for the Coverage</p>");
                    ...
                    if (200 == response.getStatusCode()) {
                            ...
                            operationList.addChangeHandler(new ChangeHandler() {
                                ...
                                public void onChange(ChangeEvent event) {
                                    ...
                                    {
                                        if(panelForWCS.remove(detailsLabel))
                                        {
                                                ...
                                                try{
                                                    ...
                                                    dc.sendRequest(null,new RequestCallback() {
                                                        ...
                                                        public void onResponseReceived(Request request, Response response) {
                                                            ...
                                                            html+="<tr> <th>Name </th> <th> Supported CRSs</th> <th>Formats </th> <th> Supported Interpolation</th></tr>";
                            ...
                            panelForWCS.add(new Label("Supported Formats:"));
                            panelForWCS.add(formatsList);
                            panelForWCS.add(new Label("Supported Coverage:"));
                                      ...
                                      //preparing the textboxes for bounding boxes
                                        ...
                                        submitButton.addClickHandler(new ClickHandler() {
                                            ...
                                            public void onClick(ClickEvent event) {
                                                ...
                                                panelForMap.remove(mapWidget);
                                                panelForMap.remove(scrollPanel);
